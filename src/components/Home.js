    ...
    <div className="body">
      ...
      <div className="footer">
        <div className="container text-center">
          ...
          <div className="row">
            <div className="col">
            <a href="https://instagram.com/ignit_power_?utm_source=qr&igshid=MzNlNGNkZWQ4Mg==">
              <svg
            ...
            <div className="col">
              <a href="https://www.facebook.com/ignit.2023?mibextid=ZbWKwL">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36"
                height="36"
            ...
            <div className="col">
              <a href="https://www.youtube.com/@INFOIGNIT03">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36"
                height="36"
